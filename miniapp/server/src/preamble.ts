...
const PREAMBLE_TAIL = [
  'Format replies for easy phone reading: answer first, then useful headings',
  'and Markdown bullets. Preserve explanations, examples, caveats and sources;',
  'improve layout rather than shortening away substance. Keep simple answers simple.',
  '',
